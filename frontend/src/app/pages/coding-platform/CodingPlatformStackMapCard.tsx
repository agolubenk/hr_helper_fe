...
export function CodingPlatformStackMapCard() {
  ...
  return (
    <Card size="2" id="stack-map">
      <Flex direction="column" gap="3">
        <Flex align="center" justify="between" gap="3" wrap="wrap">
          <Text size="2" color="gray" style={{ flex: '1 1 240px' }}>
            Карта связей каталога. Режим «только подключённые» показывает ваш текущий набор; полная — все узлы.
          </Text>
          <Flex align="center" gap="2">
            <Text size="2">Полная карта</Text>
        ...
        <Text size="2" color="gray">
          {!showFullMap
            ...
            : 'Полная схема: неподключённые узлы показаны приглушённо.'}
        </Text>
