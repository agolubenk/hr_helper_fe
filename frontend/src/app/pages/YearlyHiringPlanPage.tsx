/**
 * YearlyHiringPlanPage — годовая таблица плана найма. Маршрут: /reporting/hiring-plan/yearly.
 */
...
import styles from './styles/YearlyHiringPlanPage.module.css'
...
export function YearlyHiringPlanPage() {
  ...
  return (
    <Box className={styles.container}>
      <Flex justify="between" align="center" mb="2" wrap="nowrap" gap="3">
        <Link href="/reporting/hiring-plan" style={{ flexShrink: 0 }}>
