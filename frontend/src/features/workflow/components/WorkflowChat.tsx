...
import { ChevronDownIcon, ChevronUpIcon, PaperPlaneIcon, OpenInNewWindowIcon, EyeOpenIcon, CalendarIcon, CheckIcon, PersonIcon, Cross2Icon, ClipboardIcon, Link2Icon, ExclamationTriangleIcon } from '@radix-ui/react-icons'
...
export function WorkflowChat() {
  ...
  // Map причин отказа (ключ - ID сообщения, значение - причина отказа); setRejectionReasons используется в prompt
  const [, setRejectionReasons] = useState<Map<string, string>>(new Map())
