 ...
 * Маршрут: /recr-chat/vacancy/$vacancyId/candidate/$candidateId/assessment/$assessmentId
 */
export function RecrChatAssessmentViewPage() {
  ...
  return (
    <Box p="4">
      <Flex gap="3" mb="4" align="center">
        ...
        <Button variant="soft" size="1" asChild>
          <Link
            to="/recr-chat/vacancy/$vacancyId/candidate/$candidateId/assessment/$assessmentId/edit"
