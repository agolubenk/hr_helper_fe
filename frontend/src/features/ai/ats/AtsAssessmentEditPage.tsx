 ...
 * Маршрут: /ats/vacancy/$vacancyId/candidate/$candidateId/assessment/$assessmentId/edit
 */
  ...
  return (
    <Box p="4">
      <Flex gap="3" mb="4" align="center">
        ...
        <Button variant="soft" size="1" asChild>
          <Link
            to="/ats/vacancy/$vacancyId/candidate/$candidateId/assessment/$assessmentId"
