    ...
    <Box className={styles.header}>
      ...
      {selectedWorkflow === 'interview' && (
        <Box className={styles.interviewOptionsPanel}>
          <Flex gap="4" align="center" className={styles.interviewOptionsPanelInner}>
            {/* Тогглер формата встречи */}
            ...
            {interviewFormat === 'office' && (
              <>
                <Separator orientation="vertical" style={{ height: '24px', flexShrink: 0 }} />
