        ...
        <Grid columns="2" gap="4" width="100%" className={styles.grid} style={{ marginTop: 0 }}>
          <Box>
            ...
            <Select.Root
              ...
              onValueChange={(v) => setLightThemeAccentColor(v as AccentColorValue)}
            >
                  ...
                  <Select.Item key={color.value} value={color.value}>
                    <Flex align="center" gap="2">
                      <Box
                        ...
                        style={{ backgroundColor: COLOR_PREVIEWS[color.value] || COLOR_PREVIEWS.blue }}
                      />
                      {color.label}
                    </Flex>
                  </Select.Item>
          ...
          <Box>
            ...
            <Select.Root
              ...
              onValueChange={(v) => setDarkThemeAccentColor(v as AccentColorValue)}
            >
              <Select.Trigger style={{ width: '100%' }} />
              <Select.Content>
                {ACCENT_COLORS.map((color) => (
