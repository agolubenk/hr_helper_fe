...
import { getHuntflowUserSettings, type HuntflowUserSettings } from '@/shared/lib/huntflowUserSettings'
...
const GeminiLogo = () => (
  <Box className={styles.logoContainer}>
    <Text size="2" weight="bold" style={{ color: 'white' }}>AI</Text>
  </Box>
)

const HuntflowLogo = () => (
  <Box className={styles.logoContainer}>
    <Text size="2" weight="bold" style={{ color: 'white' }}>X</Text>
  </Box>
)

const ClickUpLogo = () => (
  <Box className={styles.logoContainer}>
    <Text size="2" weight="bold" style={{ color: 'white' }}>C</Text>
  </Box>
)

const NotionLogo = () => (
  <Box className={styles.logoContainer}>
    <Text size="2" weight="bold" style={{ color: 'white' }}>N</Text>
  </Box>
)
...
const GoogleLogo = () => (
  <Box className={styles.logoContainer}>
    <Text size="2" weight="bold" style={{ color: 'white' }}>G</Text>
  </Box>
)

const HHLogo = () => (
  <Box className={styles.logoContainer}>
    <Text size="2" weight="bold" style={{ color: 'white' }}>HH</Text>
  </Box>
)

const OpenAILogo = () => (
  <Box className={styles.logoContainer}>
    <Text size="2" weight="bold" style={{ color: 'white' }}>O</Text>
  </Box>
)
...
const N8nLogo = () => (
  <Box className={styles.logoContainer}>
    <Text size="2" weight="bold" style={{ color: 'white' }}>n8n</Text>
  </Box>
)
    ...
    <Box className={styles.integrationsBlock}>
      <Box className={styles.header}>
        <Flex align="center" gap="2">
          ...
          <Text size="4" weight="bold">Статус интеграций</Text>
        </Flex>
      </Box>

      {/* Extension card — оставляем как есть */}
      <Box className={styles.extensionCard}>
        <Flex justify="between" align="center" wrap="wrap" gap="4">
          <Flex align="center" gap="3">
            <ChromeLogo />
            <Box>
              <Text size="4" weight="bold" as="div">Расширение Chrome &quot;HR Helper&quot;</Text>
      ...
      <Box className={`${styles.helpBlock} ${styles.helpBlockHighlight}`}>
        <Text size="3" weight="medium" style={{ display: 'block', marginBottom: '8px' }}>Нужна помощь?</Text>
