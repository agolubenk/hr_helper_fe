...
import GlobalSearch from '@/shared/components/navigation/GlobalSearch/GlobalSearch'
import type { EntityData, ScopeType } from '@/shared/components/navigation/GlobalSearch/GlobalSearch'
...
export default function Header({
  ...
  const handleSearch = (query: string, scope: ScopeType | null) => {
    ...
    if (scope && scope !== 'all') search.scope = scope
    navigate({ to: '/vacancies', search: Object.keys(search).length > 0 ? search : undefined })
  }
