/**
 * RecrChatVacancyCandidatePage (recr-chat/.../candidate/[candidateId]/page.tsx) — Чат рекрутера с кандидатом по вакансии
 *
 * Назначение:
 ...
 *
 * Маршрут: /recr-chat/vacancy/[vacancyId]/candidate/[candidateId]
 */
