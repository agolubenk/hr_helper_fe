...
const INITIAL_USER: ProfileData = {
  ...
  socialLinks: [
    createSocialLink('telegram', 'talent_softnetix', { id: 'mock-social-tg-1' }),
    createSocialLink('telegram', 'agolubenk', { id: 'mock-social-tg-2' }),
    createSocialLink('linkedin', 'andrei-golubenko', { id: 'mock-social-li-1' }),
  ],
}
