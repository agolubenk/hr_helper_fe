...
import { useRouter, Link } from "@/router-adapter"
 ...
 * - accentColor: акцентный цвет для логотипа (опционально, по умолчанию 'crimson')
 */
interface HeaderProps {
  ...
  /** Акцентный цвет для логотипа (crimson, blue и др.) */
  accentColor?: string
}
