/**
 * Генерация SVG favicon как data URL для вкладки браузера (лого-робот).
 */
...
function createRobotSVG(colors: ReturnType<typeof getLogoColors>): string {
  ...
  <g transform="translate(16,16)">
    ...
    <rect x="28" y="32" width="40" height="42" rx="10" fill="url(#fg)" stroke="${colors.stroke}" stroke-width="2.4"/>
    ...
    <path d="M 34 74 Q 34 80 34 86 Q 34 90 30 90 Q 26 90 26 86 L 26 74" fill="${colors.drip}" stroke="${colors.stroke}" stroke-width="2.2" stroke-linejoin="round"/>
    <path d="M 48 74 Q 48 82 48 90 Q 48 94 44 94 Q 40 94 40 90 L 40 74" fill="${colors.drip}" stroke="${colors.stroke}" stroke-width="2.2" stroke-linejoin="round"/>
    <path d="M 62 74 Q 62 80 62 86 Q 62 90 66 90 Q 70 90 70 86 L 70 74" fill="${colors.drip}" stroke="${colors.stroke}" stroke-width="2.2" stroke-linejoin="round"/>
  </g>
  <defs>
...
/** Data URL для favicon вкладки (лого-робот по теме и акценту). */
