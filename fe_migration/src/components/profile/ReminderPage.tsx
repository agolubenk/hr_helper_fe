...
import { Box, Text, Flex, Button, TextArea, Checkbox, TextField, Switch } from '@radix-ui/themes'
import { LockClosedIcon, PlusIcon, Cross2Icon, GlobeIcon } from '@radix-ui/react-icons'
import { useState, useEffect } from 'react'
import { useToast } from '@/components/Toast/ToastContext'
import { fetchReminderPhrase, saveReminderPhrase } from '@/app/api/profile'
    ...
    <Box className={styles.reminderBlock}>
      ...
      <Box className={styles.content}>
        <Text size="2" color="gray" as="p" className={styles.hint}>
          Текст хранится в зашифрованном виде и доступен только вам. Не отображается в админке и
          нигде в явном виде.
        </Text>
