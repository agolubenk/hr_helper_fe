  ...
  return (
    <Box className={styles.vacancyCard} onClick={onClick} style={{ cursor: onClick ? 'pointer' : 'default' }}>
      ...
      <Flex justify="between" align="start" mb="2">
        ...
        {/* Рекрутер: главный + количество остальных (например, "Andrei Golubenko +2") */}
        <Flex align="center" gap="2" mb="2">
          <PersonIcon width={16} height={16} />
          <Text size="2">{vacancy.recruiter}{vacancy.recruiterExtraCount != null && vacancy.recruiterExtraCount > 0 ? ` +${vacancy.recruiterExtraCount}` : ''}</Text>
        </Flex>
        </Box>
        {/* Правая часть: статус и кнопки действий */}
