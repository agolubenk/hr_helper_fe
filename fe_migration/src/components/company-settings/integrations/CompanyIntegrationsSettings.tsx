...
import pageStyles from '@/app/pages/styles/CompanySettings.module.css'
  ...
  return (
    <Card className={integrationsStyles.card}>
      <Flex direction="column" gap="3" style={{ height: '100%' }}>
        ...
        <Box style={{ flex: 1 }} />
        <Button size="2" variant={isActive ? 'soft' : 'outline'} onClick={handleAction} style={{ alignSelf: 'flex-start' }}>
          {actionLabel}
        </Button>
      </Flex>
    </Card>
...
export function CompanyIntegrationsSettings() {
