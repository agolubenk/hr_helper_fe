...
import { PersonIcon, Pencil1Icon, CalendarIcon, LightningBoltIcon, ColorWheelIcon, ClipboardIcon, FileTextIcon } from '@radix-ui/react-icons'
import { IntegrationsIcon } from '@/shared/components/icons/IntegrationsIcon'
import styles from './ProfileNavigation.module.css'

export type ProfileTabType = 'profile' | 'edit' | 'schedule' | 'theme' | 'integrations' | 'quick-buttons' | 'requests' | 'documents'
